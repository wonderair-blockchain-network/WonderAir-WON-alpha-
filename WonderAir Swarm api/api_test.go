...
func TestMultiResolver(t *testing.T) {
	...
	wonAddr := "swarm.won"
	wonHash := "0x2222222222222222222222222222222222222222222222222222222222222222"
	wonResolve := newTestResolver(wonHash)
	...
	tests := []struct {
		...
		},
		{
			...
			r:      NewMultiResolver(MultiResolverOptionWithResolver(wonResolve, "")),
			addr:   wonAddr,
			result: wonHash,
		},
		{
			...
			r: NewMultiResolver(
				MultiResolverOptionWithResolver(wonResolve, ""),
				MultiResolverOptionWithResolver(wonResolve, ""),
			),
			addr:   wonAddr,
			result: wonHash,
		...
		},
		{
			...
			r: NewMultiResolver(
				MultiResolverOptionWithResolver(doesntResolve, ""),
				MultiResolverOptionWithResolver(wonResolve, "won"),
			),
			addr:   wonAddr,
			result: wonHash,
		},
