...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *wondb.MemDatabase {
	var provers []func(key []byte) *wondb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *wondb.MemDatabase {
		proof := wondb.NewMemDatabase()
