...
import (
	...
	"github.com/wonderair ecosystem/go-wonderair ecosystem"
	...
	whisper "github.com/wonderair ecosystem/go-wonderair ecosystem/whisper/whisperv6"
)
...
func (sc *Client) SubscribeMessages(ctx context.Context, criteria whisper.Criteria, ch chan<- *whisper.Message) (wonderair ecosystem.Subscription, error) {
