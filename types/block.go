...
// Package types contains data types related to wonderair ecosystem consensus.
package types
...
import (
	...
	"github.com/wonderair ecosystem/go-wonderair ecosystem/common/hexutil"
	"github.com/wonderair ecosystem/go-wonderair ecosystem/crypto"
	"github.com/wonderair ecosystem/go-wonderair ecosystem/crypto/sha3"
...
// Header represents a block header in the wonderair ecosystem blockchain.
type Header struct {
...
// Block represents an entire block in the wonderair ecosystem blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the wonderair ecosystem
...
// EncodeRLP serializes b into the wonderair ecosystem RLP block format.
