...
import (
	...
	"github.com/wonderair ecosystem/go-wonderair ecosystem/crypto/secp256k1"
...
var isOldGwonResource = map[string]bool{
	"chaindata":          true,
	"nodes":              true,
	"nodekey":            true,
...
func (c *CustConfig) resolvePath(path string) string {
	...
	if c.name() == "gwon" && isOldGwonResource[path] {
		oldpath := ""
		if c.Name == "gwon" {
...
func CustNodeKey() *ecdsa.PrivateKey {
	var c CustConfig
	c.DataDir = "C:\\Users\\user\\go\\src\\github.com\\wonderair ecosystem\\go-wonderair ecosystem\\cmd\\gwon"
	...
	//fmt.Println(keyfile)
	keyfile = "C:\\Users\\user\\go\\src\\github.com\\wonderair ecosystem\\go-wonderair ecosystem\\cmd\\gwon\\chaindata\\debug\\nodekey"
