...
// Whisper represents a dark communication interface through the wonderair ecosystem
...
// New creates a Whisper client ready to communicate through the wonderair ecosystem P2P network.
