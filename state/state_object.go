...
// stateObject represents an wonderair ecosystem account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of wonderair ecosystem address of the account
	data     Account
	db       *StateDB
...
// Account is the wonderair ecosystem consensus representation of accounts.
