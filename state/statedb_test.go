...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := wondb.NewMemDatabase()
	finalDb := wondb.NewMemDatabase()
...
// https://github.com/wonderair ecosystem/go-wonderair ecosystem/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(wondb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(wondb.NewMemDatabase()))
...
// See https://github.com/wonderair ecosystem/go-wonderair ecosystem/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(wondb.NewMemDatabase()))
