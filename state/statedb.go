...
// Package state provides a caching layer atop the wonderair ecosystem state trie.
package state
...
// StateDBs within the wonderair ecosystem protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/wonderair ecosystem/go-wonderair ecosystem/pull/16485#issuecomment-380438527),
